...
## Project Structure
    ...
    ├── sampleprojectbuild__28940  # Django project configurations
...
1. Clone this repo and `cd sampleprojectbuild__28940`
...
2. Clone this repo and `cd sampleprojectbuild__28940`
